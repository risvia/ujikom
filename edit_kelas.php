...
?>
      ...
      <center>
        ...
        <h2>Edit Kelas <?php echo $data['id_kelas']; ?></h2>
      <center>
      ...
      <section class="base">
        ...
        <div>
         ...
         <input type="text" name="nama_kelas" value="<?php echo $data['nama_kelas']; ?>" reqirued=""/>
        </div>
        <div>
          <label>Kompetensi Keahlian</label>
         <input type="text" name="kompetensi_keahlian" value="<?php echo $data['kompetensi_keahlian']; ?>" reqirued=""/>
        </div>
        <div>
