...
?>
      ...
      <center>
        ...
        <h2>Edit Petugas <?php echo $data['username']; ?></h2>
      <center>
      ...
      <section class="base">
        ...
        <div>
          ...
          <input type="text" name="username" value="<?php echo $data['username']; ?>"reqirued=""/>
        </div>
        <div>
          <label>Password</label>
         <input type="text" name="password" value="<?php echo $data['password']; ?>" reqirued=""/>
        </div>
        <div>
          <label>Nama Petugas</label>
         <input type="text" name="nama_petugas" value="<?php echo $data['nama_petugas']; ?>" reqirued=""/>
        </div>
        <div>
          <div>
          <label>Level</label>
         <input type="text" name="level" value="<?php echo $data['level']; ?>" reqirued=""/>
        </div>
        <div>
